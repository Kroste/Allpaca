...
/// PNG-Groessen in absteigender Schaerfe, faellt am Ende auf das scalable/
/// SVG zurueck (das wird zur Render-Zeit von Svg.Skia rastert).
/// </summary>
public static class IconLookup
{
    ...
    /// Basis-Verzeichnis erst alle PNG-Groessen, dann das scalable/SVG - sodass
    ...
    /// <summary>Alter Name, behalten fuer Backward-Compat im Test-Projekt.</summary>
